...
/**
 * Created by shangxue on 17/1/20.
 */
public class OpenFileDialog {
    ...
    static class FileSelectView extends ListView implements AdapterView.OnItemClickListener {
        ...
        private int refreshFileList()
        {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getContext(), list, R.layout.item_file_dialog, new String[]{"img", "name", "path"}, new int[]{R.id.filedialogitem_img, R.id.filedialogitem_name, R.id.filedialogitem_path});
